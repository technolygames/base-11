...
public class MenuDatosVentana2 extends javax.swing.JFrame{
    public MenuDatosVentana2(){
        initComponents();
        new MediaHandler().setLookAndFeel(MenuDatosVentana2.this);
    ...
    protected final void botones(){
        ...
        jMenuItem1.addActionListener(a->
                MediaHandler.openPanel(MenuDatosVentana2.this,new DelDatosPanel2())
        );
        
        jMenuItem2.addActionListener(a->
                MediaHandler.openPanel(MenuDatosVentana2.this,new ModDatosPanel2())
        );
    }
